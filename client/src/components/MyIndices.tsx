...
export const MyIndices = () => {
  const createdIndices = useSelectedCryptos((s) => s.createdIndices);
    ...
    <div className="container max-w-6xl mx-auto">
      <div className="bg-white p-6 rounded-xl border border-black/10 mb-6">
        ...
        <p className="text-gray-600">
          {createdIndices.length} {createdIndices.length === 1 ? "index" : "indices"} created
        </p>
      </div>

      {createdIndices.length === 0 ? (
            ...
            >
              ...
              <div className="space-y-2 mb-4">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold">{index.backtestSettings.period}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">Benchmark:</span>
                  <span className="font-semibold">{index.backtestSettings.benchmark}</span>
                </div>
              </div>
